...
[← HDA-NAS](https://github.com/backmind/tutorials/blob/main/hda-nas.md) **|** [↑ HDA-SERV](#indice) **|** [HDA-TERM →](https://github.com/backmind/tutorials/blob/main/hda-term.md) **|** [HDA-DOCKER →→](/dev/null)
...
2. [Preámbulo](#preambulo)
    ...
    2. [¿Qué es un homelab?, ¿por qué un homelab?](#homelab)
    3. [Hardware](#hardware)
4. [Primeros pasos](#primerospasos)
    1. [Sources list](#sources)
    2. [Sudo](#sudo)
    3. [SSH config](#ssh)
    4. [Firewall](#firewall)
    5. [Wake on lan](#wol)
    6. [Restos de la configuración básica](#basica)
5. [Macroconfiguración de zsh](#zsh)
    1. [Instalando el core](#zshcore)
    2. [oh-my-zsh plugins](#zshplugins)
    3. [Configurando .zshrc](#zshrc)
6. [Instalando CUDA drivers](#cuda)
7. [Instalando zfs](#zfs)
    1. [Crear un pool de cero](#pool)
    2. [Montar un volumen](#volumen)
8. [Samba](#samba)
    1. [Configurando las opciones globales de Samba](#sambacfg)
    2. [Creando directorios compartidos de Samba](#sambadir)
    3. [Creando Samba Share User y grupo](#sambausr)
9. [Docker](#docker)
    1. [Instalación de Docker](#dockerinst)
    2. [Docker rootless mode](#dockerrootless)
    3. [Nvidia docker toolkit](#dockernvidia)
